...
- **HEROKU_EMAIL**: Heroku Account email Id in which the above app will be deployed, for more info you can read [heroku-guide.md](https://github.com/breakdowns/slam-mirrorbot/blob/master/heroku-guide.md) (**NOTE**: Only needed if you deploying on Heroku with Github Workflow).
...
<p><a href="https://github.com/breakdowns/slam-mirrorbot/blob/master/heroku-guide.md"> <img src="https://img.shields.io/badge/Heroku%20Guide-blueviolet?style=for-the-badge&logo=heroku" width="180""/></a></p>
